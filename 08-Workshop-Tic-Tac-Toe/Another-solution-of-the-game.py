# не е най-елегантното решение, но действа, само липсва проверка дали играча е вкарал празно поле за Име
...
symbols = ["X", "O"]
board = [[" ", " ", " "], [" ", " ", " "], [" ", " ", " "]]
board_coords = {1: [0, 0], 2: [0, 1], 3: [0, 2], 4: [1, 0], 5: [1, 1], 6: [1, 2], 7: [2, 0], 8: [2, 1], 9: [2, 2]}
while True:
